// Ported unchanged from the official Zed C# extension
// (https://github.com/zed-extensions/csharp, src/language_servers/nuget.rs).
// Generic NuGet v3 client used to fetch the self-contained
// roslyn-language-server build directly, with no `dotnet tool install`
// dependency.
